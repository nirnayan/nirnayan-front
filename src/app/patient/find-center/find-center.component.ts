...
export class FindCenterComponent implements OnInit {
  ...
  saveEnquary() {
    ...
    formData.append('book_date', this.form.book_date);
    formData.append('address', this.form.address);
    formData.append('document', this.uploadfile);

    if (this.form.name && this.form.mobile && this.form.book_date &&
      this.form.address && this.form.gender && this.form.document) {
      this.loader = false;
